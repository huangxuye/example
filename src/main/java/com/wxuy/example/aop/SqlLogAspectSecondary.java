...
@Component
@Order(100)
public class SqlLogAspectSecondary {
...
/*    @Autowired  //默认的数据源
    ...
    private Logger logger = LoggerFactory.getLogger(SqlLogAspectSecondary.class);
    ...
    @Pointcut("execution(* com.wxuy.example.mapper.secondary..*.*(..))")
    public void sqlLog() {}
