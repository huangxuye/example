...
/*    @Autowired  //默认的数据源
    ...
    @Autowired
    @Qualifier("TLogSqlSessionFactory")
    private SqlSessionFactory sqlSessionFactory;


    private Logger logger = LoggerFactory.getLogger(SqlLogAspectTLog.class);
    ...
    @Pointcut("execution(* com.wxuy.example.mapper.tLog..*.*(..))")
    public void sqlLog() {}
